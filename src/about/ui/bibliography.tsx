...
export default function AboutProject(
  ...
  return (
    <>
      ...
      <Markup
        markupService={markupService}
        text="@bib{baker2004archive}; @bib{fromebllab0023}; @bib{baragli2022sonnengruesse}; @bib{fromebllab0034}; @bib{fromebllab0035}; @bib{barton1900some}; @bib{PBS_9_1}; @bib{YOS_19}; @bib{bernhardtSumerischeLiterarischeTexte1961}; @bib{bernhardtSumerischeLiterarischeTexte1967}; @bib{bernhardtSozialokonomischeTexteUnd1976}; @bib{RN1800}; @bib{Biggs_Al-Hiba_1976}; @bib{biggs1988early}; @bib{RN61}; @bib{RN62}; @bib{RN1459}; @bib{UBHD-65281075}; @bib{RN3177}; @bib{RN850}; @bib{RN54}; @bib{RN56}; @bib{RN883}; @bib{RN1530}; @bib{RN1599}; @bib{RN32}"
      />
      <h4>C</h4>
      <Markup
        markupService={markupService}
      ...
      <Markup
        markupService={markupService}
        text="@bib{RN2605}; @bib{RN2742}; @bib{RN1271vv}; @bib{ellis1984neobabylonian}; @bib{ellis1997notes}; @bib{englund2014late}; @bib{epping1891neue}; @bib{epping1891neue2}; @bib{epping1891neue3}; @bib{evetts1892inscriptions}"
      />
      <h4>F</h4>
      <Markup
        markupService={markupService}
      ...
      <Markup
        markupService={markupService}
        text="@bib{UBHD-31041537}; @bib{YOS_4}; @bib{CT0049}; @bib{LS243}; @bib{kessler2000hellenistische}; @bib{kilmer2005akkadian}; @bib{CT001}; @bib{UBHD-65324131}; @bib{CT003}; @bib{CT005}; @bib{CT007}; @bib{CT0010}; @bib{CT009}; @bib{RN2700}; @bib{RN1525}; @bib{RN2604}; @bib{CT0021}; @bib{CT0024}; @bib{CT0025}; @bib{CT0026}; @bib{CT0029}; @bib{CT0032}; @bib{CT0033}; @bib{RN2604a}; @bib{RN1189a}; @bib{RN1189}; @bib{RN1153ax}; @bib{AOAT_358}; @bib{kleinerman2011education}; @bib{VS_18}; @bib{VS_22}; @bib{VS_29}; @bib{RN465}; @bib{RN464}; @bib{RN1271ae}; @bib{BAM_2}; @bib{RN1271e}; @bib{RN1271c}; @bib{RN1271b}; @bib{RN1271a}; @bib{RN1271}; @bib{SLTNi}; @bib{ISET_1}; @bib{ISET_2}; @bib{ISET_3}; @bib{RN2100ab}; @bib{AbB_1}; @bib{AbB_4}; @bib{RN2100}; @bib{RN1334}; @bib{AbB_10}; @bib{krueckmannNeubabylonischeRechtsUnd1933a}; @bib{RN311c}"
      />
      <h4>L</h4>
      <Markup
        markupService={markupService}
