  ...
  },
  {
    ...
    content: (markupService) => (
      <>
        <MarkupParagraph
          markupService={markupService}
          text="The acquisition registers of the Vorderasiatisches Museum (Staatliche Museen zu Berlin, Preußischer Kulturbesitz) were digitised within the framework of the project “Provenienz und Bestand. Online-Publikation der Erwerbungsbücher und Zugangsverzeichnisse der Staatlichen Museen zu Berlin”, initiated and funded by the Beauftragte der Bundesregierung für Kultur und Medien (see @url{here}{https://www.smb.museum/museen-einrichtungen/vorderasiatisches-museum/sammeln-forschen/erwerbungsbuecher/}). The digitised volumes are published in the online database of Heidelberg University Library (see @url{here}{https://digi.ub.uni-heidelberg.de/diglit/smb_vorderasiatisches_museum}) under a Creative Commons license."
        />
