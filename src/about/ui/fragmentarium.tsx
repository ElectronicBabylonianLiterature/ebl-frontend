...
displayed in the Fragmentarium, e.g. @url{/fragmentarium/DT.1}{DT.1}."
      ...
      <Markup
        markupService={markupService}
        text="Geers’ copies have been digitized from the copy once in the Oriental Institute of The University of Chicago, kindly donated by Prof. Martha T. Roth to the Institut für Assyriologie und Hethitologie of Munich University."
      />
