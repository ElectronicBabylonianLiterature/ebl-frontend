...
export default function AboutProject(
  ...
  return (
    <>
      ...
      <Markup
        markupService={markupService}
        text="Geers’ copies have been digitized from the copy once in the Oriental Institute 
              of The University of Chicago, kindly donated by Prof. Martha T. Roth to the 
              Institut für Assyriologie und Hethitologie of Munich University."
      />
      ...
      <Markup
        markupService={markupService}
        text="Erica Reiner was a Hungarian-American Assyriologist, one of the main forces 
              behind the epoch-making @i{The Assyrian Dictionary of the Oriental Institute of 
              the University of Chicago}. During her long and productive career, Reiner was 
              the world’s foremost expert in Mesopotamian celestial divination, a field in 
              which she produced several fundamental studies, such as the series of 
              monographs @i{Babylonian Planetary Omens} (with D. Pingree)."
      />
      <p />
      <Markup
        markupService={markupService}
