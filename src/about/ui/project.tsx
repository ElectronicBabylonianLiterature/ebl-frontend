  ...
  return (
    <div className="project-page">
      <header className="project-hero">
        ...
        <h2 className="project-hero__title">eBL Project</h2>
        <p className="project-hero__lead">
          Reconstructing Babylonian literature and making fragmentary texts
          searchable, accessible, and usable for scholarship.
        </p>
      </header>
      ...
      <section className="project-section">
        <div className="project-section__header">
          ...
          <p className="project-section__subtitle">
            From fragmentary discovery to reconstructed literature.
          </p>
        </div>

        <div className="project-intro">
          <div className="project-intro__text">
            <div className="gilgamesh-quote">
              <div className="gilgamesh-quote__fragmentary">
                <span className="gilgamesh-quote__line">
                  [… who s]aw the Deep, […] the country,
                </span>
                <span className="gilgamesh-quote__line gilgamesh-quote__parallel">
                  [who] knew […], […] all […]
                </span>
                <span className="gilgamesh-quote__line">
              ...
              <div className="gilgamesh-quote__restored">
                <span className="gilgamesh-quote__line">
      ...
      <section className="project-section">
        ...
        <div className="team-photos">
          <figure className="team-photos__item">
            <img src={eblteam2020} alt="The eBL Team in 2020" />
            <figcaption>The eBL Team in 2020</figcaption>
          </figure>
          <figure className="team-photos__item">
            <img src={eblteam2023} alt="The eBL Team in 2023" />
            <figcaption>The eBL Team in 2023</figcaption>
          </figure>
        </div>
      ...
      <section className="project-section">
        <div className="project-section__header">
          ...
          <p className="project-section__subtitle">
            Institutional partners supporting research and access.
          </p>
        </div>
        <div className="institutions">
          <ul>
            <li>
              ...
              London. A particular debt of gratitude is owed to Dr. Jonathan
              Taylor, Assistant Keeper (Department of the Middle East) for his
              continued support of the project. Photographs of cuneiform tablets
              kept in the British Museum are published online with the kind
            ...
            <li>
              ...
              . Thanks are expressed to Prof. Stephen J. Tinney, Deputy Director
              and Chief Curator.
            </li>
            <li>
