...
/**
 * A height key rather than a colour key: colour is already explained by the
 * shared 2D legend, so this adds only what extrusion introduces — what the
 * height means, how it is scaled, and what it explicitly does not mean.
 */
