...
/**
 * Samples the *completed* measurement line only, once, against the terrain
 * already loaded for the map — there is no elevation request per point and no
 * new API. A stale run is discarded through the cancellation flag rather than
 * being allowed to overwrite a newer measurement.
 */
