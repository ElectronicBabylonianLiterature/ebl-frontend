...
/**
 * Attribution reproduced verbatim from the Tilezen joerd requirement at
 * https://github.com/tilezen/joerd/blob/master/docs/attribution.md. Only the
 * clauses covering the eBL sites are omitted-free: the full text is required
 * because a single source served over Iraq (SRTM) is credited jointly with
 * GMTED2010 in the final clause.
 */
...
/**
 * The single approved DEM source, or null when it fails a rights, transport or
 * coverage gate. Callers must treat null as "terrain is unavailable" and render
 * no terrain control at all.
 */
