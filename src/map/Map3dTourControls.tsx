...
/**
 * The same control in the tools panel and in presentation mode. Progress is
 * announced politely — camera movement itself is never announced — and focus
 * returns to Start when the tour ends.
 */
