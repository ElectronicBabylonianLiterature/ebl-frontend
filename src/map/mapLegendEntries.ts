...
/**
 * The single legend model. Both the on-map legend and the visualization panel
 * render these entries, so the two can never drift apart or describe the same
 * polygon state in two different vocabularies.
 */
