...
/**
 * Even–odd ray casting. Points exactly on an edge are not guaranteed either
 * result; spatial search treats such a polygon as a candidate anyway because
 * the segment-crossing test also runs.
 */
...
/**
 * True when the geometry overlaps the search ring: a shared vertex, a crossing
 * edge, or full containment in either direction.
 */
