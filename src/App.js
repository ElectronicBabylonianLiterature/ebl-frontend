...
import TextEditorPrototype from './corpus/TextEditorPrototype'
    ...
    <SessionContext.Provider value={auth.getSession()}>
      ...
      <ErrorBoundary>
        <Switch>
          ...
          <Route path='/corpus/proto/:id' render={props => <TextEditorPrototype fragmentService={fragmentService} {...props} />} />
