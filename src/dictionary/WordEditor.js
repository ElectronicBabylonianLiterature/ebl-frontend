...
import { Loading, Form, Input, Checkbox, Button, Alert, Select, Collapse } from 'element-react'
...
class WordEditor extends Component {
  ...
  render () {
    ...
    return this.state.word ? (
      ...
      this.state.error ? <Alert type='error' title={this.state.error.message} showIcon closable={false} /> : <Loading fullscreen />
    )
  }
}
