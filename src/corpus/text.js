...
const Period = Record({ name: '', abbreviation: '', description: '', parent: null, hasModifiers: false })
export const periods = OrderedMap({
  ...
  'Old Babylonian': Period({ name: 'Old Babylonian', abbreviation: 'OB', description: '(ca. 2002–1595 BCE)', parent: null, hasModifiers: true }),
  'Middle Babylonian': Period({ name: 'Middle Babylonian', abbreviation: 'MB', description: '(ca. 1595–1000 BCE)', parent: null, hasModifiers: true }),
  'Middle Assyrian': Period({ name: 'Middle Assyrian', abbreviation: 'MA', description: '(ca. 1595–1000 BCE)', parent: null, hasModifiers: true }),
  'Hittite': Period({ name: 'Hittite', abbreviation: 'Hit', description: '(ca. 1500–1100 BCE)', parent: null }),
  'Neo-Assyrian': Period({ name: 'Neo-Assyrian', abbreviation: 'NA', description: '(ca. 1000–609 BCE)', parent: null, hasModifiers: true }),
  'Neo-Babylonian': Period({ name: 'Neo-Babylonian', abbreviation: 'NB', description: '(ca. 1000–539 BCE)', parent: null }),
  'Late Babylonian': Period({ name: 'Late Babylonian', abbreviation: 'LB', description: '(ca. 539 BCE–ca. 100 CE)', parent: null, hasModifiers: true }),
