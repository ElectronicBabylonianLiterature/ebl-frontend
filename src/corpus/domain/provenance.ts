export const Provenances = {
  ...
  'Dūr-Katlimmu': { name: 'Dūr-Katlimmu', abbreviation: 'Dka', parent: 'Assyria', },
  ...
  'Imgur-Enlil': { name: 'Imgur-Enlil', abbreviation: 'Img', parent: 'Assyria', },
  Kalḫu: { name: 'Kalḫu', abbreviation: 'Kal', parent: 'Assyria' },
  'Kār-Tukulti-Ninurta': { name: 'Kār-Tukulti-Ninurta', abbreviation: 'Ktn', parent: 'Assyria', },
  Khorsabad: { name: 'Khorsabad', abbreviation: 'Kho', parent: 'Assyria' },
  Nineveh: { name: 'Nineveh', abbreviation: 'Nin', parent: 'Assyria' },
  'Šubat-Enlil': { name: 'Šubat-Enlil', abbreviation: 'Šub', parent: 'Assyria', },
  ...
  'Bad-Tibira': { name: 'Bad-Tibira', abbreviation: 'Btb', parent: 'Babylonia', },
  ...
  'Dūr-Kurigalzu': { name: 'Dūr-Kurigalzu', abbreviation: 'Dku', parent: 'Babylonia', },
  ...
  Ḫursagkalama: { name: 'Ḫursagkalama', abbreviation: 'Hur', parent: 'Babylonia', },
  ...
  'Maškan-šāpir': { name: 'Maškan-šāpir', abbreviation: 'Maš', parent: 'Babylonia', },
  ...
  'Puzriš-Dagān': { name: 'Puzriš-Dagān', abbreviation: 'Puz', parent: 'Babylonia', },
  Sippar: { name: 'Sippar', abbreviation: 'Sip', parent: 'Babylonia' },
  'Sippar-Amnānum': { name: 'Sippar-Amnānum', abbreviation: 'Sipam', parent: 'Babylonia', },
  ...
  'Tell el-Amarna': { name: 'Tell el-Amarna', abbreviation: 'Ama', parent: 'Periphery', },
  ...
  'Tepe Gotvand': { name: 'Tepe Gotvand', abbreviation: 'Tgo', parent: 'Periphery', },
