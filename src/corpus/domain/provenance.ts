export const Provenances = {
  ...
  Girumu: { name: 'Girumu', abbreviation: 'Grm', parent: 'Babylonia' },
  Ḫursagkalama: {
    name: 'Ḫursagkalama',
    abbreviation: 'Hur',
    parent: 'Babylonia',
  ...
  Mukdan: { name: 'Mukdan', abbreviation: 'Muk', parent: 'Babylonia' },
  ...
  Ḫadatu: { name: 'Ḫadatu', abbreviation: 'Had', parent: 'Periphery' },
  Hamath: { name: 'Hamath', abbreviation: 'Ham', parent: 'Periphery' },
  Ḫattuša: { name: 'Ḫattuša', abbreviation: 'Hat', parent: 'Periphery' },
  Jericho: { name: 'Jericho', abbreviation: 'Jer', parent: 'Periphery' },
