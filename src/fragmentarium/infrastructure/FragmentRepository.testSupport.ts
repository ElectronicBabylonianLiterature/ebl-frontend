...
export type MockedApiClient = ReturnType<typeof createApiClient>

export interface FragmentRepositoryTestContext {
  apiClient: MockedApiClient
  fragmentRepository: FragmentRepository
}

export function createFragmentRepositoryTestContext(): FragmentRepositoryTestContext {
...
export const emptyMatchingLinePreview = {
  lines: [],
  numberOfLines: 0,
  // eslint-disable-next-line camelcase
