...
export default function ExternalResources({
  ...
  const externalNumbers: ReadonlyArray<[string, ExternalLinkComponent]> = [
    ...
    [fragment.getExternalNumber('ontarioNumber'), ontarioLink],
    [fragment.getExternalNumber('kelseyNumber'), kelseyLink],
    [fragment.getExternalNumber('harvardHamNumber'), harvardHamLink],
    [fragment.getExternalNumber('etcsriNumber'), etcsriLink],
    [fragment.getExternalNumber('sketchfabNumber'), sketchfabLink],
    [fragment.getExternalNumber('arkNumber'), arkLink],
