# TASK-1 TODO: Auto-create `.env.local` and inject Codespaces secrets

## Checklist

- [x] Verify `.env.local` is in `.gitignore` — confirmed
- [x] Create `.devcontainer/init.sh`
- [x] Add `initializeCommand` to `.devcontainer/devcontainer.json`
- [x] Update root `README.md` – step 6 in Option 1 (Codespaces)
